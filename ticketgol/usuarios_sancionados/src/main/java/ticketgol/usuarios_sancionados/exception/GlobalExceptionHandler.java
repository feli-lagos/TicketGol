...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(UsuarioSancionadoNotFoundException.class)
    public ResponseEntity<Map<String, Object>> handleUsuarioSancionadoNotFoundException(UsuarioSancionadoNotFoundException ex) {
        return buildErrorResponse(HttpStatus.NOT_FOUND, "Not Found", ex.getMessage());
    }
